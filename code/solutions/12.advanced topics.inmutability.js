...
(function (/* 02. IList #1 */) {
    ...
    var IList = function (data) {
        ...
        return {
            ...
            tail: function () {
                return IList (items.slice (1));
            },
            insert: function (e) {
                return IList ([e].concat (items));
            },
            empty: function () {
                return this.size () === 0;
            },
    ...
    var IList = function (data) {
        ...
        return (function List (node) {
            return {   
                ...
                toArray: function () {
                    return (function toArray (node) {
                        return !node.tail ?
                            [] :
                            [node.first].concat (toArray (node.tail));
                    })(node);
                },
                toString: function () {
...
(function (/* 04. lReduce, lMap & lFilter  */ ) {
    ...
    var lMap = function (list, fn) {
        return lInvert (
            lReduce (list, function (a, e, list) {
                return a.insert (fn (e, list));
            }, IList ())
        );
    };
